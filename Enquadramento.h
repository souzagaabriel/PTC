...
#ifndef UNTITLED_ENQUADRAMENTO_H
#define UNTITLED_ENQUADRAMENTO_H
...
private:
    ...
    Serial & porta;
    unsigned char buffer[4096]; // quadros no maximo de 4 kB (hardcoded)
...
#endif //UNTITLED_ENQUADRAMENTO_H
